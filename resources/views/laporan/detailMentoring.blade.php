...
@section('title','SIMPIB - Laporan Mentoring')
...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
			<a href="/laporanMentoring" class="btn btn-secondary">
                Kembali
            </a>
		</div>
		<div class="card-body">
            ...
            <div>
                <div class="text-center">
                    <form action="/cetakLaporanMentoring" method="GET">
                    ...
                    {{-- <a href="/cetakLaporanMentoring/{{$form->id}}" class="btn btn-primary btn-sm" id="pdf"><i class="fa fa-print"> Export PDF</i></a> --}}
                </div>
            </div>
