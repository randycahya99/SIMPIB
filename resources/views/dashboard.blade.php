...
<div class="container-fluid">
	...
	@elseif (auth()->user()->hasAnyRole('pemonev','perusahaan'))
				...
				<div class="col-xl-4 col-md-6 mb-4">
					<div class="card border-left-primary shadow h-100 py-2">
						<div class="card-body">
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									<div class="text-xs font-weight-bold text-dark text-uppercase mb-1">Laporan Mentoring</div>
									<div class="mb-0 font-weight-bold text-gray-800">{{$laporanMentoring}} Laporan</div>
								</div>
								<div class="col-auto">
									<i class="fas fa-file fa-2x text-gray-300"></i>
								</div>
				...
				<div class="col-xl-4 col-md-6 mb-4">
					<div class="card border-left-success shadow h-100 py-2">
						<div class="card-body">
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									<div class="text-xs font-weight-bold text-dark text-uppercase mb-1">Laporan Pendampingan</div>
									<div class="mb-0 font-weight-bold text-gray-800">{{$laporanPendampingan}} Laporan</div>
								</div>
								<div class="col-auto">
									<i class="fas fa-file fa-2x text-gray-300"></i>
								</div>
