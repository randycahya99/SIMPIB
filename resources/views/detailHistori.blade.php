...
@if (Auth::user()->hasRole('tenant')||Auth::user()->hasRole('calon tenant'))
...
@elseif (Auth::user()->hasRole('coach')||Auth::user()->hasRole('mentor')||Auth::user()->hasRole('pendamping'))

@section('title','SIMPIB - Detail Tenant')
...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
			<a href="/daftarTenant" class="btn btn-secondary">
                Kembali
            </a>
		</div>
		<div class="card-body">
            ...
            <h4 class="card-text font-weight-bold">Profile Tenant</h4><br>
            <div class="container-fluid">
                <div class="form-group row">
                    <p class=" col-sm-4 font-weight-bold">Nama Lengkap</p>
                    <div class="col-sm-8">
            ...
            <br><h4 class="card-text font-weight-bold">Profile Usaha Tenant</h4><br>
            <div class="container-fluid">
                <div class="form-group row">
                    <p class=" col-sm-4 font-weight-bold">Nama Usaha</p>
                    <div class="col-sm-8">
...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
			<a href="/tenant" class="btn btn-secondary">
                Kembali
            </a>
		</div>
		<div class="card-body">
            ...
            <div class="container-fluid">
                <div class="form-group row">
                    <p class=" col-sm-4 font-weight-bold">Coach</p>
                    <div class="container-fluid">
                        <div class="form-group row">
                            <p class=" col-sm-4">Kode</p>
                            <div class="col-sm-8">
                                <p>: {{$tenant->coachs->categories->kode_coach}}</p>
                            </div>
                            <p class=" col-sm-4">Nama</p>
                            <div class="col-sm-8">
                                <p>: {{$tenant->coachs->nama_coach}}</p>
                            </div>
                            <p class=" col-sm-4">Bidang Keahlian</p>
                            <div class="col-sm-8">
                                <p>: {{$tenant->coachs->bidangs->bidang_keahlian}} ({{$tenant->coachs->bidangs->kode_bidang}})</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group row">
                            <p class=" col-sm-4">Kode</p>
                            <div class="col-sm-8">
                                <p>: {{$tenant->mentors->categories->kode_mentor}}</p>
                            </div>
                            <p class=" col-sm-4">Nama</p>
                            <div class="col-sm-8">
                                <p>: {{$tenant->mentors->nama_mentor}}</p>
                            </div>
                            <p class=" col-sm-4">Bidang Keahlian</p>
                            <div class="col-sm-8">
                                <p>: {{$tenant->mentors->bidangs->bidang_keahlian}} ({{$tenant->mentors->bidangs->kode_bidang}})</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="form-group row">
                            <p class=" col-sm-4">Kode</p>
                            <div class="col-sm-8">
                                <p>: {{$tenant->pendampings->categories->kode_pendamping}}</p>
                            </div>
                            <p class=" col-sm-4">Nama</p>
                            <div class="col-sm-8">
                                <p>: {{$tenant->pendampings->nama_pendamping}}</p>
                            </div>
                            <p class=" col-sm-4">Bidang Keahlian</p>
                            <div class="col-sm-8">
                                <p>: {{$tenant->pendampings->bidangs->bidang_keahlian}} ({{$tenant->pendampings->bidangs->kode_bidang}})</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <br><h4 class="card-text font-weight-bold">Profile Tenant</h4><br>
            <div class="container-fluid">
                <div class="form-group row">
                    <p class=" col-sm-4 font-weight-bold">Nama Lengkap</p>
                    <div class="col-sm-8">
